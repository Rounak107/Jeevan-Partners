...
useEffect(() => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-emerald-500 via-green-600 to-teal-700">
...
>
  ...
  <span className="bg-gradient-to-r from-peach-500 to-white-600 bg-clip-text text-transparent">
    Couple Marriage
  </span>
</Link>
